	                            ...
	                            <div class="col-xs-6 col-sm-6 col-md-6">
	                                <div class="form-group">
	                                    ...
	                                    <select name="disease" class="form-control" required="">
	                                        <option selected="" value="-1" disabled="">Selectionnez une maladie</option>
	                                        <option value="Maladies normales">Maladies normales</option>
	                                        <option value="Cancer">Cancer</option>
	                                        <option value="Maladies cœliaques">Maladies carliaques</option>
	                                        ...
	                                        <option value="Maladies privées">Maladies privees</option>
