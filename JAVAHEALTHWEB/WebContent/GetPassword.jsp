                                    ...
                                    <center>
                                        <%
                                            try {
                                                ...
                                                PreparedStatement ps = con.prepareStatement("select Pass from Table_Doctor where Dname=? and Email=? ");
                                                ps.setString(1, Name);
                                                ps.setString(2, email);
                                                ResultSet rs = ps.executeQuery();
                                                if (!rs.next()) {
                                                    out.println("<center><h3>Sorry! Patient Name or Patient Email-ID does not match.</h3></center>");
                                                    out.println("<hr><center><a href='ForgotPassword.jsp'>Try Again</a></center>");
                                                } else {
